...
const socialLinks = [
  {
    href: "https://github.com/pranavsikhwal",
    label: "GitHub",
    icon: <GitHub />,
  },
  {
    href: "https://www.instagram.com/_pranavsikhwal?igsh=MXQxbWF2YTB2d3hhbA==",
    label: "Instagram",
    icon: <Instagram />,
  },
];
    ...
    <div className="border-t bg-muted/100 backdrop-blur-sm">
      <footer className="  mx-auto w-full max-w-5xl *:px-4 *:md:px-6  ">
        <div className="flex flex-col gap-6 py-6">
          ...
          <nav>
            <ul className="flex flex-wrap gap-4 font-medium text-muted-foreground text-sm md:gap-6 items-center">
              {navLinks.map((link) => (
                <li key={link.label}>
        ...
        <div className="flex items-center justify-between gap-4 border-t py-4 text-muted-foreground text-sm">
          <p>&copy; {new Date().getFullYear()} KASRAT</p>
